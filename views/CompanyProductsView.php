...
<div class="container  p-0" style="">
    ...
    <div class="d-flex" style="border: 2px solid #224099; border-radius:20px 20px 0 0; background-color:#224099 ;">
        <div class="btn" style="padding: 20px;">
          <b href="#" style="font-size: 24px; color: #f48120;">
          	<?php 
                //co the goi ham tu class model o day
                $company = $this->getCompany($macty);
    ...
    <div style="border: 2px solid #224099; border-radius:0 0 20px 20px; padding: 20px;">
        <table class="table table-data table-hover">
         ...
         ?>       </td>
                    <td>
                    	<a class="btn btn-hover" href="index.php?controller=request&action=create&masp=<?php echo $rows->masp; ?>">Yêu cầu</a>&nbsp;
                        <!-- <a class="btn btn-hover" href="index.php?controller=products&action=detail&masp=<?php echo $rows->masp; ?>" >Chi tiết</a> -->
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination">
            <li class="page-item">
              ...
              <li class="page-item"><a class="page-link" href="index.php?controller=products&action=company&macty=<?php echo $macty; ?>&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
            <?php endfor; ?>
